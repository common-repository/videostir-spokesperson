...
//var_dump($sql);
        ...
        $info['type'] = 'updated';
        $info['text'] = 'Clip appearance settings updated.';
...
<div class="wrap">
    ...
    <h2><img class="logo" src="<?php echo $this->logo; ?>" alt="VideoStir" />  Video Settings</h2>
        ...
        <div style="width: 60%;float: left;">
             <?php if (!$playerParams):?>                
                <div id="formdiv" class="postbox " style="border: 1px solid rgba(0,0,0,0.25); box-shadow: 0 5px 15px rgba(0,0,0,0.15);" >
                    ...
                    <div class="inside">
                      ...
                      (position, dimensions, behavior, buttons, text on clip etc...)
                    </div>
                </div>     
            <?php endif ?> 
            <form method="post" action="" onsubmit="return validateVideoStirEditForm();">
                <div id="formdiv" class="postbox " style="border: 1px solid rgba(0,0,0,0.25); box-shadow: 0 5px 15px rgba(0,0,0,0.15);" >
                    ...
                    <?php endif ?> 
                    <h3 style="cursor: default;">Choose the pages/posts for the clip to play on</h3>
                            ...
                            <div class="posts-container" style="margin-top:5px;">
                                ...
                                //if (get_option('page_on_front') == 0) {
                                    ...
                                    if (!in_array(0, $excludepages)) {
                                        ...
                                        <label class="selpage">
                                                                                    <input type="checkbox" class="pages" name="pages[]" id="home" value="0" <?php echo (in_array($home_id, $apages)) ? 'checked="checked"' : ''; ?> /> 
                                                                                    Home
                                                                            </label>
            ...
            <div id="formdiv" class="postbox " style="border: 1px solid rgba(0,0,0,0.25); box-shadow: 0 5px 15px rgba(0,0,0,0.15);" >
                ...
                <div class="inside">
                    <form method="post" action="">
                        <div class="spacer-10">&nbsp;</div>
                        <label for="name">Clip's Name:</label> 
                        <input id="name" name="name" value="<?php echo $video['name']; ?>" style="width: 200px;height:26px;" />
